...
def main(args):
    ...
    if is_sim:
        ...
        from custom.custom_constants import TASK_CONFIGS
...
def eval_bc(config, ckpt_name, save_episode=True):
    ...
    for rollout_id in range(num_rollouts):
        ...
        if real_robot:
            env.recorder_arm.move_gripper(MAX_GRIP, move_time=0.5)  # open
            # move_grippers([env.puppet_bot_left, env.puppet_bot_right], [PUPPET_GRIPPER_JOINT_OPEN] * 2, move_time=0.5)  # open
            pass

        # inference 완료 후 Gripper 열게하는 명령 추가하기
        ...
        if len(rewards) > 0:
            ...
            print("[WARN] No rewards computed for this episode.")
        # reward 계산X
